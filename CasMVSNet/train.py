...
parser.add_argument('--trainpath', default="../data/dtu_training/mvs_training/dtu/", help='train datapath')
parser.add_argument('--testpath', default="../data/dtu_training/mvs_training/dtu/", help='test datapath')
